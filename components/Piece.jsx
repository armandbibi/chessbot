...
function ShapePiece({ piece, placement, style, changeBoard, board }) {
    ...
    return (
        ...
        >
            ...
            >
                <G transform="translate(0.000000,185.000000) scale(0.100000,-0.100000)" fill={color} stroke="none">
